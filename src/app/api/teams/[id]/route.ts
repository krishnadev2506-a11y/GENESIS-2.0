...
export async function PATCH(
  ...
  try {
    ...
    const allowedUpdates = ['teamName', 'college', 'semester', 'contactNumber', 'projectIdea', 'email', 'members', 'scoreboardPoints', 'checkedIn', 'route', 'paymentStatus', 'paymentScreenshotUrl', 'transactionId'];
