      ...
      <aside className="hidden md:flex flex-col w-[260px] fixed inset-y-0 left-0 bg-glass border-r border-glass-border backdrop-blur-xl z-20">
        ...
        <div className="p-6 border-b border-[rgba(255,255,255,0.08)]">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-pulse flex items-center justify-center font-display font-bold text-xl">
              B
            </div>
            <div>
              <p className="text-sm text-text-muted">Welcome back,</p>
              <p className="font-bold text-white truncate">Byte Benders</p>
            </div>
          </div>
        </div>
