...
import { LayoutDashboard, Mail, Users, CheckSquare, LogOut, Menu, X, Award, FileText, Sparkles } from 'lucide-react';
...
export function DashboardShell({
  ...
  const navItems = [
    ...
    { name: 'Challenges', href: '/dashboard/challenges', icon: Sparkles },
