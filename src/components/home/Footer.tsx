    ...
    <footer className="relative mt-24 border-t border-[rgba(255,255,255,0.08)] bg-[linear-gradient(180deg,rgba(20,16,30,0.62),rgba(10,10,15,0.94))] px-4 pb-8 pt-16 sm:px-6 lg:px-8 backdrop-blur-xl">
      ...
      <div className="mx-auto mb-12 flex max-w-7xl flex-col justify-between gap-10 md:flex-row md:items-start">
        ...
        <div className="grid grid-cols-2 gap-12 sm:grid-cols-3 sm:gap-16">
          ...
          <div>
            <h4 className="label-caps mb-4 text-sm text-white">Resources</h4>
            <ul className="space-y-3">
              <li>
                <a
                  href="/rulebook.pdf"
                  ...
                  className="inline-flex items-center gap-1.5 text-text-muted transition-colors hover:text-accent-secondary"
                >
              ...
              <li><Link href="/#tracks" className="text-text-muted transition-colors hover:text-accent-secondary">Competition Tracks</Link></li>
              <li><Link href="/#evaluation" className="text-text-muted transition-colors hover:text-accent-secondary">Evaluation Criteria</Link></li>
              <li><Link href="/#submissions" className="text-text-muted transition-colors hover:text-accent-secondary">Submission Guide</Link></li>
            </ul>
          </div>
