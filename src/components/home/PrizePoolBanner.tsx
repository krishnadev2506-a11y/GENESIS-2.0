    ...
    <div className="relative w-full z-20 mt-12 mb-20 flex justify-center">
      ...
      >
        <div className="relative flex flex-col md:flex-row items-center justify-between p-6 sm:p-8 md:p-10 gap-8 sm:gap-10 w-full rounded-[1.5rem] sm:rounded-3xl border border-white/[0.08] bg-[#0c0814] shadow-[0_10px_40px_rgba(0,0,0,0.4)] overflow-hidden group">
          ...
          <div className="absolute inset-0 pointer-events-none opacity-20 group-hover:opacity-40 transition-opacity duration-700" style={{ background: 'radial-gradient(120% 120% at 0% 0%, rgba(168, 85, 247, 0.2) 0%, transparent 50%), radial-gradient(120% 120% at 100% 100%, rgba(59, 130, 246, 0.2) 0%, transparent 50%)' }} />
          ...
          <div className="absolute bottom-0 left-[20%] right-[20%] h-[1px] bg-gradient-to-r from-transparent via-blue-400/20 to-transparent opacity-50" />
          ...
          <div className="relative z-20 flex justify-center items-center">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/30 to-blue-500/30 blur-2xl rounded-full opacity-40 group-hover:opacity-70 transition-opacity duration-700 pointer-events-none" />
            ...
            <div className="relative flex items-center gap-4 sm:gap-6 bg-white/[0.03] border border-white/10 px-6 sm:px-10 py-5 sm:py-6 rounded-[1.25rem] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl group-hover:bg-white/[0.05] group-hover:border-white/20 transition-all duration-500">
              ...
              <m.div 
                ...
                className="relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full shadow-[0_10px_20px_rgba(0,0,0,0.6),0_0_30px_rgba(59,130,246,0.3)]"
              >
                {/* Outer metallic rim */}
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-purple-400 via-blue-400 to-indigo-500 opacity-100 shadow-[inset_0_2px_4px_rgba(255,255,255,0.5),inset_0_-2px_4px_rgba(0,0,0,0.5)]" />
                
                {/* Inner embossed face */}
                <div className="relative w-[80%] h-[80%] rounded-full bg-gradient-to-br from-[#1b102b] to-[#0a192f] flex items-center justify-center shadow-[inset_0_-3px_5px_rgba(255,255,255,0.15),inset_0_3px_6px_rgba(0,0,0,0.7),0_3px_5px_rgba(0,0,0,0.5)] overflow-hidden">
              ...
              <m.div 
                ...
                className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 w-6 h-6 sm:w-8 sm:h-8 text-blue-300 drop-shadow-[0_0_12px_rgba(59,130,246,1)]"
              >
