          ...
          <div className="relative z-10 pointer-events-none" style={{ transform: "translateZ(40px)" }}>
            ...
            <div className="flex flex-col items-center justify-center gap-6 sm:flex-row pointer-events-auto" style={{ transform: "translateZ(30px)" }}>
              ...
              <a
                ...
                id="cta-rulebook-btn"
              >
                <Button size="lg" variant="secondary" className="px-10 py-4 text-sm font-bold uppercase tracking-widest flex items-center gap-3 bg-white/5 hover:bg-white/10 border-white/10 hover:border-white/20 hover:-translate-y-1 transition-all">
