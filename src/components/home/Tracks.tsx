  ...
  return (
    ...
    >
      <m.div
        ...
        className="relative h-full min-h-[480px] flex flex-col p-8 sm:p-10 md:p-12 hover:-translate-y-3 transition-transform duration-700 group overflow-hidden rounded-3xl border"
        style={{
      ...
      >
        ...
        <div 
          className="absolute top-10 right-10 w-24 h-24 sm:w-32 sm:h-32 opacity-20 group-hover:opacity-50 transition-opacity duration-700 pointer-events-none"
          style={{ transform: "translateZ(-40px)" }}
        >
          <m.div 
            animate={{ rotateY: 360, rotateX: 360 }}
            transition={{ duration: 25 + index * 5, repeat: Infinity, ease: "linear" }}
            className="w-full h-full rounded-2xl border flex items-center justify-center backdrop-blur-sm"
            style={{ 
          ...
          >
            <div className="absolute inset-2 border rounded-xl" style={{ borderColor: track.borderColor, transform: "translateZ(20px)" }} />
            <div className="absolute inset-4 border rounded-lg" style={{ borderColor: track.borderColor, transform: "translateZ(40px)" }} />
          </m.div>
        </div>

        {/* Header Section */}
        <div className="mb-auto flex flex-col items-start gap-4 relative z-10 w-full pointer-events-none" style={{ transform: "translateZ(30px)" }}>
          ...
          <div className="w-full relative z-10 flex flex-col items-start">
            ...
            {/* Theme Display Box */}
            <div className="w-full relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/5 bg-black/40 p-4 sm:p-6 backdrop-blur-md group-hover:border-white/15 transition-all duration-700 shadow-inner" style={{ transform: "translateZ(20px)" }}>
        ...
        {/* Bottom Action Area */}
        <div className="mt-10 relative z-10" style={{ transform: "translateZ(40px)" }}>
