...
import { LayoutDashboard, Users, UserCheck, MessageSquare, Upload, BellRing, Settings, LogOut } from 'lucide-react'
...
export const AdminSidebar = () => {
  ...
  return (
    <div className="w-[260px] flex-shrink-0 bg-cp-dark border-r border-cp-border flex flex-col h-screen sticky top-0">
      <div className="p-6 border-b border-cp-border bg-[rgba(255,45,120,0.02)]">
